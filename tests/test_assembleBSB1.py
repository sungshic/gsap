...
pre_processor.buildBamIndex(base_dir+'tests/data/test_ref_data/sorted_reads.bam')

print('removing unmapped reads...')
pre_processor.removeUnmappedReads(base_dir+'tests/data/test_ref_data/sorted_reads.bam', base_dir+'data/test_ref_data/filtered_sample_aligned.bam', base_dir+'data/test_ref_data/unmapped_reads.bam')

print('build bam index for filtered_sample_aligned.bam')
pre_processor.buildBamIndex(base_dir+'tests/data/test_ref_data/filtered_sample_aligned.bam')
...
pre_processor.buildBamIndex(base_dir+'tests/data/test_ref_data/addrg_reads.bam')
...
subprocess.call(['./src/gsap/getconsensusfasta3.sh', base_dir+'tests/data/RefGenome/AL009126_v11/AL009126.fasta', base_dir+'tests/data/test_ref_data/addrg_reads.bam', base_dir+'tests/data/test_ref_data/consensus.fasta', base_dir+'src/gsap/'])
# fastq to fasta
