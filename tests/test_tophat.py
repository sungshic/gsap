...
from gsap.tuxedpreprocessing import TPreProcessor


@pytest.mark.skip(reason="migration from old code base unfinished")
def test_tophat():
    ...
    tpp = TPreProcessor(
        "data/sequencing/rna_seq/hg19",
        "data/sequencing/rna_seq/adrenal_1.fastq",
        "data/sequencing/rna_seq/hg19_transcripts",
        rawdata_paired2_filepath="data/sequencing/rna_seq/adrenal_2.fastq",
        data_outdir="data/sequencing/results/",
    )
    ...
    tpp.cuffdiff(
        ...
        ["adrenal_tophat/accepted_hits.bam", "brain_tophat/accepted_hits.bam"],
        "cuffdiff",
    )
